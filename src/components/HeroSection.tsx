  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight md:leading-tight tracking-tight mb-6">
          <motion.span
          ...
          <span className="relative inline-block overflow-hidden h-[1.2em] align-bottom">
            {words.map((word, index) => (
              ...
              >
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">{word}</span>
              </motion.span>
            ))}
          </span>
        </h1>
